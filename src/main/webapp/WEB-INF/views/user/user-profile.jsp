                ...
                <div class="bg-primary" style="min-height: 150px;">
                    <div class="d-flex align-items-end container page__container" style="position: absolute; left: 0; right: 0; bottom: 0;">
                        <div class="avatar avatar-xl">
                            <img src="https://taimienphi.vn/tmp/cf/aut/cZ1E-anh-avatar-dep-2.jpg" alt="avatar" class="avatar-img rounded" style="border: 2px solid white;">
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="text-muted d-flex align-items-center">
                            <i class="material-icons mr-1">${user.address}</i>
                            <div class="flex">Núi Chua Chan</div>
                        </div>
                        <div class="text-muted d-flex align-items-center">
